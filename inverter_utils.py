...
def get_inverter_data(start_date_start_obj, start_date_end_obj, end_date_start_obj, end_date_end_obj,
                     mongo_connection, site_id, device_id):
    ...
    while current_start_timestamp <= end_date_start_obj and current_end_timestamp <= end_date_end_obj:
        ...
        plant_record = list(mongo_connection.db.inverter_history.find({"$and": [{"site_id": site_id},
                                                                             {"device_id":device_id},
                                                                            {"record_timestamp": {
            ...
            '_id': 0, "today_energy": 1, "record_time": 2, "p_pr": 3}).sort("record_time", -1).limit(1))
        # wst = list(
        ...
        for each_data in plant_record:
            ...
            final_result["energy"].append(each_data.get("today_energy", 0))
